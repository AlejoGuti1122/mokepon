...
function unirseAlJuego() {
  fetch("http://192.168.10.16:8080/unirse").then(function (res) {
    if (res.ok) {
...
function enviarAtaques() {
  fetch(`http://192.168.10.16:8080/mokepon/${jugadorId}/ataques`, {
    method: "post",
    headers: {
      "Content-Type": "application/json",
    },
...
function obtenerAtaques() {
  fetch(`http://192.168.10.16:8080/mokepon/${enemigoId}/ataques`).then(
    function (res) {
      if (res.ok) {
